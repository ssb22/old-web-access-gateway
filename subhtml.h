...
extern TEContainer* encodingsInCurrentUse;
...
extern bool doneConversionAlready;
inline void subHtmlDone() { doneConversionAlready=true; }
#else
inline int subHtmlFgetc(FILE* in,InString &htmlLineInput,int &lineInputPtr) { return(text_fgetc(in)); }
inline int subHtmlFeof(FILE* in,InString &htmlLineInput,int lineInputPtr) { return(feof(in)); }
inline void subHtmlDone() { return; }
#endif
