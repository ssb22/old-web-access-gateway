...
#include "instring.h"
/**
Decodes ampersand sequences like &eacute;
for displaying accented characters with the Unicode
system
(also needed by xhtml.c++)
*/
void ampersandFilter(const char* src,InString &dest,int outXml=0);
//#endif
